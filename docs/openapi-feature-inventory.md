...
| stream-extension-model | `StreamProtocol`, `StreamAdapter`, `StreamCodec`, built-in SSE JSON default, client defaults, per-request override, explicit raw-frame adapter override, generated Webhook/Callback inbound reuse | 3.2 | generated | `internal/target/typescript/server_body_test.go::TestGeneratedWebhookRouterUsesDefaultSSEJSONAdapterAndCustomRawFrames` |
